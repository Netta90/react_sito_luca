				...
				<div>
					...
					<div className="row featurette sfondo">
						<div className="col-md-7 no-padding">
							<h2 classNames="featurette-heading contentName">Ma che cos'è esattamente la Neuro Linguistica? <span class="text-muted">provo a spiegarlo in breve:
							</span></h2>
							<p className="lead contentName">La programmazione neuro linguistica (PNL), è un metodo di comunicazione e un sistema di "life coaching” o meglio definito come «un approccio alla comunicazione volta allo sviluppo personale.
